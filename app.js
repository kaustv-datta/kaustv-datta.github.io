...
var _user$project$Models$CityAccidentsRoutes = {ctor: 'CityAccidentsRoutes'};
var _user$project$Models$StateCrimesRoute = {ctor: 'StateCrimesRoute'};
var _user$project$Models$LeadersRoute = {ctor: 'LeadersRoute'};
...
var _user$project$Msgs$OnFetchLSLeaders = function (a) {
...
var _user$project$Commands$fetchLSLeaders = A2(
	...
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(_elm_lang$http$Http$get, _user$project$Commands$fetchLSLeadersUrl, _user$project$Commands$lsLeadersDecoder)));

var _user$project$Routing$riversPath = '#rivers';
var _user$project$Routing$accidentsPath = '#accidents';
var _user$project$Routing$crimesPath = '#crimes';
var _user$project$Routing$leadersPath = '#leaders';
var _user$project$Routing$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Models$LeadersRoute, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Models$LeadersRoute,
				_evancz$url_parser$UrlParser$s('leaders')),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Models$StateCrimesRoute,
					_evancz$url_parser$UrlParser$s('crimes')),
				_1: {
					ctor: '::',
					_0: A2(
						_evancz$url_parser$UrlParser$map,
						_user$project$Models$CityAccidentsRoutes,
						_evancz$url_parser$UrlParser$s('accidents')),
					_1: {
						ctor: '::',
						_0: A2(
							_evancz$url_parser$UrlParser$map,
							_user$project$Models$RiversRoute,
							_evancz$url_parser$UrlParser$s('rivers')),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Views_Leaders$leaderRow = F2(
	function (index, leader) {
		return A2(
			_elm_lang$html$Html$ul,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('data-row'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('data-column'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('data-list__serial-no'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('data-list__member-name'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('data-list__member-state'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('progress-bar horizontal'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('progress-track'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('progress-info'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('progress-fill'),
															_1: {
																ctor: '::',
...
var _user$project$Views_Leaders$list = F2(
	function (leaders, title) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('our-leaders__data-list'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('data-list__wrapper'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('data-list__container'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('data-list__title'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('data-list__list'),
											_1: {ctor: '[]'}
										},
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('our-leaders__data-list-wrapper'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$Views_Dashboard$page = function (model) {
	var _p0 = model.route;
	switch (_p0.ctor) {
		case 'LeadersRoute':
...
var _user$project$Views_Dashboard$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('side-bar'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('site-logo'),
							_1: {
								ctor: '::',
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$alt('My India Logo'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$src('site-logo.png'),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('main-nav'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													_elm_lang$html$Html$a,
													{
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$href(_user$project$Routing$leadersPath),
															_1: {ctor: '[]'}
														}
													},
													{
												...
												{ctor: '[]'},
												{
													...
													_0: A2(
														_elm_lang$html$Html$a,
														{
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$href(_user$project$Routing$crimesPath),
																_1: {ctor: '[]'}
															}
														},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Crime in States'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}),
													...
													{ctor: '[]'},
													{
														...
														_0: A2(
															_elm_lang$html$Html$a,
															{
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$href(_user$project$Routing$accidentsPath),
																	_1: {ctor: '[]'}
																}
															},
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Accidents in Cities'),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}),
														...
														{ctor: '[]'},
														{
															...
															_0: A2(
																_elm_lang$html$Html$a,
																{
																	...
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$href(_user$project$Routing$riversPath),
																		_1: {ctor: '[]'}
																	}
																},
																{
					...
					},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _user$project$Views_Dashboard$page(model),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$Main$main = A2(
	...
	{init: _user$project$Main$init, view: _user$project$Views_Dashboard$view, update: _user$project$Update$update, subscriptions: _user$project$Main$subscriptions})();
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js??ref--0-2!./main.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js??ref--0-2!./main.css");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js??ref--0-2!./normalize.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js??ref--0-2!./normalize.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
