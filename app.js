...
var _user$project$Models$initialModel = {leaders: _krisajenkins$remotedata$RemoteData$Loading};
...
var _user$project$Msgs$OnFetchLeaders = function (a) {
...
var _user$project$Commands$fetchLeaders = A2(
	...
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(_elm_lang$http$Http$get, _user$project$Commands$fetchLeadersUrl, _user$project$Commands$leadersDecoder)));
...
var _user$project$Views_Leaders_List$view = function (response) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Views_Leaders_List$nav,
			_1: {
				ctor: '::',
				_0: _user$project$Views_Leaders_List$maybeList(response),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Views_Dashboard$page = function (model) {
	return _user$project$Views_Leaders_List$view(model.leaders);
};
...
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Models$initialModel, _1: _user$project$Commands$fetchLeaders};
